...
We can directly use an area graph: 
...
peaking of points (mentioned in the solution to the previous exercise), let’s take
a look at some next, in the context of critiquing a less than ideal graph.

![](../documentation/bankIndex.png)

How to transform to a more clear chart: 
